...
demos display the result of calling evry method of TPJComputerInfo, TPJOSInfo
...
1) VCL Directory
   ...
   program definately will not compile with Delphi 3.
   ...
   * For Delphi 2006 and earlier you need to manually create a Win32 sub-
     directory of VCL to receive the ouput binaries.
...
2) FMX Directory
   ...
   This directory contains a demo program that compiles for the FireMonkey
   framework.
